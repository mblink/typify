...
object ZipApply {
  ...
  inline def apply[FL, AL](using z: ZipApply[FL, AL]): Aux[FL, AL, z.Out] = z

  given emptyTupleZipApply: Aux[EmptyTuple, EmptyTuple, EmptyTuple] =
